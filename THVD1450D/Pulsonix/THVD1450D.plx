...
//1332025/1009899/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "THVD1450D" (originalName "THVD1450D")
	...
	(compDef "THVD1450D" (originalName "THVD1450D") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "THVD1450D"))
		...
		(attr "Manufacturer_Part_Number" "THVD1450D")
		(attr "Mouser Part Number" "595-THVD1450D")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/THVD1450D?qs=chTDxNqvsylemUKR9F4kpw%3D%3D")
		(attr "Arrow Part Number" "THVD1450D")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/thvd1450d/texas-instruments?region=europe")
		(attr "Description" "3.3-V to 5-V RS-485 transceiver with +/-18-kV IEC ESD protection")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/THVD1450")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "THVD1450D.stp")
